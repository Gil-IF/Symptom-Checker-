...
$rata_level = $total_screening > 0
    ? $riwayat[0]['nama_level']
    : '-';
...
|--------------------------------------------------------------------------
*/
function getEmoji(string $level): string
{
    $level = strtolower($level);

    if (str_contains($level, 'rendah') || str_contains($level, 'normal')) {
        return '🙂';
    }

    if (str_contains($level, 'sedang') || str_contains($level, 'ringan')) {
        return '😐';
    }
...
<div class="main-content">
    ...
    <div class="summary-cards">
        ...
        <div class="summary-card">
            ...
            <div class="value"><?= htmlspecialchars($rata_level); ?></div>
            <div class="desc">Berdasarkan hasil terbaru</div>
        </div>
        ...
        <?php else: ?>
            <div class="history-list">
                <?php foreach ($riwayat as $item): ?>
                    <?php
                        $persen = getPersentase((int)$item['skor_total']);
                        $emoji = getEmoji($item['nama_level']);
                    ?>
                    <div class="history-item">
                        <div class="history-left">
                            ...
                            <div class="history-detail">
                                ...
                                <span class="history-badge">
                                    <?= htmlspecialchars($item['nama_level']); ?>
                                </span>
                                <br>
                                <a
                                    href="../skrining/result.php?id_skrining=<?= $item['id_skrining']; ?>"
                                    class="history-link"
                                >
                                    Lihat Detail Hasil →
                                </a>
                        ...
                        <div class="history-score">
                            <h5>Skor Total</h5>
                            <p><?= (int)$item['skor_total']; ?> (<?= $persen; ?>%)</p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
