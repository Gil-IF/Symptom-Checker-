...
<div class="wrap">
    ...
    <!-- Hanya include drawer navigasi, jangan include halaman skrining -->
    ...
    <main class="hero">
        ...
        <section class="cards">
            <!-- Gunakan path relatif, bukan absolute lokal -->
            ...
            <a href="../riwayat/index.php" class="card mint">
                <div>
                    <h2>History Check</h2>
                    <p>
                        Revisit your previous check results and see how your
                        emotional condition changes over time.
                    </p>
                </div>
            </a>
        </section>
        ...
        <div class="wave">
            <svg viewBox="0 0 1280 90" preserveAspectRatio="none">
                <path
                    d="M0 55 L160 74 L320 56 L480 35 L640 58
                       L800 38 L960 48 L1120 36 L1280 50
                       L1280 90 L0 90 Z"
                    fill="#cdb4e6" />
            </svg>
        </div>
