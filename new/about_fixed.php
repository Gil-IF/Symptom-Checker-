...
<body>
  <header class="topbar">
    <div class="topbar-inner">
      <a href="index.php" class="brand" aria-label="Symptom Checker home">
      ...
      <nav aria-label="Primary">
        <ul class="nav-links">
          <?php if ($is_logged_in): ?>
            ...
            <li><a href="skrining/index.php">Checking</a></li>
            <li><a href="riwayat/index.php">Riwayat</a></li>
          <?php endif; ?>
  ...
  <main class="page">
    ...
    <section class="section hero">
      <div>
        ...
        <p>
          ...
          daily habits. Based on these answers, the system provides an initial overview of the possible
          psychological condition they may be experiencing, along with guidance for the next steps.
        </p>
      </div>
      ...
      <div class="waves" aria-hidden="true">
        <svg viewBox="0 0 1100 55" preserveAspectRatio="none" width="100%" height="55">
          <path d="M0 30 L160 12 L330 42 L520 8 L700 38 L890 6 L1100 30 L1100 55 L0 55 Z" fill="#a8ddd0" opacity=".55"></path>
          <path d="M0 40 L200 18 L400 46 L600 14 L800 44 L1000 16 L1100 38 L1100 55 L0 55 Z" fill="#6dbfac" opacity=".4"></path>
        </svg>
      </div>
    </section>
    ...
    <section class="section why">
      <div class="why-ill">
        <img src="../assets/img/helpme.png" alt="Ilustrasi membantu">
      </div>
      ...
      <div class="waves" aria-hidden="true">
        <svg viewBox="0 0 1100 48" preserveAspectRatio="none" width="100%" height="48">
          <path d="M0 24 L170 9 L340 34 L520 6 L710 32 L900 5 L1100 26 L1100 48 L0 48 Z" fill="#9ec8da" opacity=".5"></path>
          <path d="M0 32 L210 12 L420 38 L620 10 L820 36 L1020 12 L1100 30 L1100 48 L0 48 Z" fill="#7ab8d9" opacity=".4"></path>
        </svg>
      </div>
    </section>
    ...
    <section class="section how">
      ...
      <div class="steps">
        ...
        <div class="step">
          ...
          <p>The system processes the answers based on structured mental health screening indicators.</p>
        </div>
        <div class="step">
    ...
    <section class="section cta">
      ...
      <?php if ($is_logged_in): ?>
        <a class="cta-btn" href="skrining/index.php">Start Checking</a>
      <?php else: ?>
        <a class="cta-btn" href="login.php">Start Now</a>
      <?php endif; ?>
    </section>
  </main>
</body>
